// registrar-login.js — Registrar-side login; drives registrar/index.html, the
// module's entry point.
// Talks to Controllers/registrar/registrar_controllers.php via RegistrarModel.
...
// views/admission.html. Mirrors the cashier login flow.
//
...
(function () {
  ...
  M.redirectIfAuthed("views/admission.html");
  ...
  loginForm.addEventListener("submit", function (e) {
    ...
    M.login(email, password).then(function (data) {
      if (data && data.success) {
        ...
        window.location.href = data.redirect || "views/admission.html";
        return;
      }
