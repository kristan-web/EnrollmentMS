...
<head>
  ...
  <title>Get Started &middot; Student Portal</title>
  ...
  <div class="wrap">
    ...
    <section class="choice">
      <div class="section-head section-head--center">
        ...
        <p>Start a new application, or check one you already submitted.</p>
      </div>
      ...
      <div class="choice-grid">
        <a class="portal-card portal-card--amber" href="apply.html">
          ...
          <p>Complete the five-step application form and upload your admission requirements online.</p>
          <span class="portal-card__go">Start application
        ...
        <a class="portal-card" href="check-status.html">
          ...
          <p>Enter your reference number and email to see where your application is and any registrar remarks.</p>
          <span class="portal-card__go">Check status
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
          </span>
        </a>
      </div>
