...
function showDashMenu(role){
    if(role === 'Registrar'){
        return `
        <li>
            <a href="Views/RegistrarSide/data-entry.php">
        ...
        <li>
            <a href="Views/RegistrarSide/transaction.php">
                <span class="submenu__icon" aria-hidden="true">
         ...
         <li>
            <a href="Views/RegistrarSide/records.php">
                <span class="submenu__icon" aria-hidden="true">
    ...
    if(role === 'Admin'){
        ...
        <li>
            <a href="Views/AdminSide/settings.php">
                <span class="submenu__icon" aria-hidden="true">
        ...
        <li>
            <a href="Views/AdminSide/maintenance.php">
                <span class="submenu__icon" aria-hidden="true">
