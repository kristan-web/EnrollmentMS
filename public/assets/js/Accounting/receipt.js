/* Controller for receipt.php: reads the URL PayMongo returned to and draws
   the matching screen.
  ...
  function actions() {
    return (
      '<div class="wizard-nav" style="justify-content:center;border-top:none;padding-top:20px;gap:12px;flex-wrap:wrap;">' +
        '<a class="btn btn--ghost" href="pay.php">Pay another fee</a>' +
        '<a class="btn btn--primary" href="index.php">Back to Cashier</a>' +
      "</div>"
    );
  }
