...
/* Data access for the fee schedule.
   Reads `acct_fees` (created by accounting/sql/schema/01_accounting_tables.sql,
   filled by accounting/sql/seed/02_fee_schedule.sql) so the amounts can be
   edited in the database instead of in the code.

   FeeSchedule in ../Models/payment_model.php is the only caller. It falls back
