...
<head>
  ...
  <title>SHS Subject &middot; Enrollment Management System</title>
...
<body>
    ...
    <section class="content content--settings">
      <header class="page-head">
        <nav class="page-head__crumbs" aria-label="Breadcrumb">
          ...
          <span aria-current="page">SHS subject</span>
        </nav>
        <h1 class="page-head__title">SHS Subject</h1>
        <p class="page-head__desc">Manage core, applied, and specialized subjects offered across senior high school year levels.</p>
      </header>
      ...
      <div class="toolbar">
        ...
        <div class="search-box">
          ...
          <input type="search" id="searchInput" class="search" placeholder="Search by code or title..." />
      ...
      <div class="panel">
        ...
        <p class="empty" id="emptyState" hidden>No subjects yet. Click "Add Subject" to get started.</p>
  ...
  <div class="modal-overlay" id="subjectModal" hidden>
    <div class="modal modal--small" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
      <div class="modal__head">
        <h2 id="modalTitle">Add Subject</h2>
        <button class="modal__close" id="closeSubjectModal" aria-label="Close">&times;</button>
      </div>
      <div class="modal__body">
        <form id="subjectForm" class="settings-form" novalidate>
          <div class="form-row">
            <label class="field">
              <span>Subject Code <span class="required">*</span></span>
              <input type="text" name="subject_code" placeholder="e.g. STEM-GB1" autocomplete="off" maxlength="20" required />
            </label>
            <label class="field">
              <span>Unit(s) <span class="required">*</span></span>
              <input type="number" name="units" min="1" max="10" placeholder="e.g. 2" required />
            </label>
          </div>
          <label class="field">
            <span>Descriptive Title <span class="required">*</span></span>
            <input type="text" name="subject_name" placeholder="e.g. General Biology 1" autocomplete="off" required />
          </label>
          <div class="form-row">
            <label class="field">
          ...
          <div class="form-row">
            ...
            <label class="field">
              <span>Strand (Optional)</span>
              <select name="strand_id">
                <option value="">— All Strands (Core/Applied) —</option>
              </select>
            </label>
          </div>
          <label class="field">
            <span>Description (Optional)</span>
            <textarea name="description" placeholder="Brief description of the subject" rows="3"></textarea>
          </label>
          <label class="field">
            <span>Status</span>
            <select name="status">
          ...
          <p class="form-msg" id="subjectMsg" role="status"></p>
          <div class="form-actions">
            <button type="button" class="btn btn--ghost" id="cancelSubjectBtn">Cancel</button>
  ...
  <div class="modal-overlay" id="deleteModal" hidden>
    <div class="modal modal--small" role="dialog" aria-modal="true" aria-labelledby="deleteTitle">
      <div class="modal__head">
        <h2 id="deleteTitle">Delete Subject</h2>
        <button class="modal__close" id="closeDeleteModal" aria-label="Close">&times;</button>
      </div>
      <div class="modal__body">
        <p class="archive-name" id="deleteName"></p>
        <p class="archive-note" id="deleteNote">This will deactivate the subject. It can be restored by changing the status to Active.</p>
        <div class="form-actions">
  ...
  <script src="../../../public/assets/js/Subjects/shs-subject.js"></script>
</body>
</html>