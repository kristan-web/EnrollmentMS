...
<head>
  ...
  <title>Settings &middot; Enrollment Management System</title>
...
<body>
  ...
  <div class="main">
    ...
    <h1 class="main__title main__title--hero">Settings</h1>
    <p class="main__subtitle">Manage user accounts and system preferences</p>

    <section class="page-links">
      <a class="page-card" href="../../../Accounts/View/user-settings.php">
