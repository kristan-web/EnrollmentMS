...
<head>
  ...
  <title>Transaction &middot; Enrollment Management System</title>
...
<body>
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <ul class="nav__submenu is-open" id="dashMenu">
        ...
        <li><a href="../AdminSide/settings.php">
          <span class="submenu__icon" aria-hidden="true">
        ...
        <li><a href="../AdminSide/maintenance.php">
          <span class="submenu__icon" aria-hidden="true">
  ...
  <div class="main">
    ...
    <h1 class="main__title main__title--hero">Transaction</h1>
    <p class="main__subtitle">Process student enrollments and class schedules</p>

    <section class="page-links">
      <a class="page-card" href="../../../Enrollment/View/enrollment.php">
      ...
      <a class="page-card" href="../../../Schedules/View/schedule.php">
