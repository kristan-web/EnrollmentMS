...
<!-- Accounting module entry point: the cashier login (flowchart: START -> Login).
     ...
     View/cashier.php once the account checks out. Theme is portal.css. -->
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <title>Cashier Login &middot; Cashier &amp; Accounting</title>
...
<body>
  ...
  <div class="wrap wrap--status">
    <header class="topbar">
      <a class="topbar__brand" href="index.php" aria-label="Cashier login">
    ...
    <main class="login">
      ...
      <h1 class="login__title">Cashier Login</h1>
      <p class="login__subtitle">Sign in with your staff account to record payments</p>
      ...
      <nav class="portal-nav" aria-label="Other staff portals">
        ...
        <div class="portal-nav__grid">
          ...
          <a class="portal-link portal-link--accounting" href="/EnrollmentMS/app/Registrar/View/index.php">
            <span class="portal-link__icon" aria-hidden="true">
  ...
  <script src="/EnrollmentMS/public/assets/js/Accounting/cashier-login.js"></script>
</body>
</html>
