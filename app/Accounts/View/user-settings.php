  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <ul class="nav__submenu is-open" id="dashMenu">
        <li><a href="../..//Dashboards/Views/RegistrarSide/data-entry.html">
          <span class="submenu__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>
          </span>
          <span>Data entry</span>
        </a></li>
        <li><a href="../../Dashboards/Views/RegistrarSide/transaction.html">
          <span class="submenu__icon" aria-hidden="true">
        ...
        <li><a href="../../Dashboards/Views/AdminSide/settings.html" class="is-active">
          <span class="submenu__icon" aria-hidden="true">
        ...
        <li><a href="../../Dashboards/Views/AdminSide/maintenance.html">
          <span class="submenu__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76Z"/></svg>
          </span>
          <span>Maintenance</span>
        </a></li>
        <li><a href="../../Dashboards/Views/RegistrarSide/records.html">
          <span class="submenu__icon" aria-hidden="true">
    ...
    <a class="sidebar__logout" href="../../../public/index.html">
      <span class="nav__icon" aria-hidden="true">
    ...
    <section class="content content--settings">
      <header class="page-head">
        <nav class="page-head__crumbs" aria-label="Breadcrumb">
          <a href="../../Dashboards/Views/AdminSide/settings.html">Settings</a>
